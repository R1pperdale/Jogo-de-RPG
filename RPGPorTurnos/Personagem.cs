    ...
    public class Personagem
    {
        ...
        public void criacaoPersonagem()
        {
            ...
            do
            {
                ...
                Console.WriteLine("6 - VELOCISTA");
                Console.WriteLine("");
                Console.WriteLine("Escreva qual a classe do seu personagem");
                classe = Console.ReadLine();
            } while (classe != "GUERREIRO" && classe != "ARQUEIRO" && classe != "MAGO" && classe != "MONGE" && classe != "NINJA" && classe != "VELOCISTA");
        ...
        public void construirVelocista()
        {
            experiencia = 0;
            nivel = 1;
            pontosdevida = 75;
